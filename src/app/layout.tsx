...
// Minimal root layout — provides <html> and <body> with fonts.
// ClerkProvider is intentionally NOT here; it lives in (main)/layout.tsx
// so that (payload)/admin routes are never wrapped by Clerk.
